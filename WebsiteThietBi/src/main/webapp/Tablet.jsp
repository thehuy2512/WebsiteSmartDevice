...
<div class="container-fluid text-center" style="width: 90%;background-color: yellow;">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p style="font-weight: 600;font-family: monospace;font-size: 30px">Thương hiệu Tablet</p>
      <div style="background-color: white;"><a href="SanPhamThuongHieuController?maloai=tablet&mathuonghieu=apple&tentrang=Tablet" style="font-size: 40px;color: red;"><i class="uil uil-apple"></i> Apple</a></div>
      <div style="background-color: blue;"><a href="SanPhamThuongHieuController?maloai=tablet&mathuonghieu=samsung&tentrang=Tablet" style="font-size: 40px;color: white;">Samsung</a></div>
