    ...
    <div class="row">
      <div class="col-md-6 offset-md-3">
        ...
        <div class="card my-5">
          ...
          <form class="card-body cardbody-color p-lg-5" action="KTDangKyController" method="POST">
			...
			<div class="mb-3">
              <input type="text" class="form-control" id="Fullname" name="txthoten" aria-describedby="emailHelp"
                placeholder="Full name" required="">
            </div><div class="mb-3">
              <input type="text" class="form-control" id="Address" name="txtdiachi" aria-describedby="emailHelp"
                placeholder="Address" required="">
            </div><div class="mb-3">
              <input type="text" class="form-control" id="Phonenumber" name="txtsdt" aria-describedby="emailHelp"
            ...
            <div id="emailHelp" class="form-text text-center mb-5 text-dark">Already
              account? <a href="Login.jsp" class="text-dark fw-bold"> Login now
                </a>
            </div>
          </form>
        </div>
