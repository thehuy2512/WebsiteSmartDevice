...
<div class="container-fluid text-center" style="width: 90%;background-color: yellow;">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p style="font-weight: 600;font-family: monospace;font-size: 30px">Thương hiệu Laptop</p>
      <div style="background-color: white;"><a href="SanPhamThuongHieuController?maloai=lap&mathuonghieu=apple&tentrang=Laptop" style="font-size: 40px;color: red;"><i class="uil uil-apple"></i> Apple</a></div>
      <div style="background-color: #CECFD5;"><a href="SanPhamThuongHieuController?maloai=lap&mathuonghieu=dell&tentrang=Laptop" style="font-size: 40px;color:#1D3CD4;">DELL</a></div>
      <div style="background-color: white;"><a href="SanPhamThuongHieuController?maloai=lap&mathuonghieu=asus&tentrang=Laptop" style="font-size: 40px;color:#271C8A;">ASUS</a></div>
...
<div class="grid-container" style="width: 90%;margin: auto;border: 1px solid;">
		<c:forEach items="${dssp}" var="sp">
			<div class="grid-item">
				...
				<p style="font-family: monospace;">Giá sản phẩm: ${sp.getGia() }
					VNĐ</p>
				<c:choose>
				...
				<a
					href="GioHangController?masp=${sp.getMasp()}&tensp=${sp.getTensp()}&gia=${sp.getGia()}&maloai=${sp.getMaloai()}&mathuonghieu=${sp.getMathuonghieu()}&anh=${sp.getAnh()}"><img
					style="width: 150px" src="image/nutdathang.png"></a>
			</div>
		</c:forEach>
