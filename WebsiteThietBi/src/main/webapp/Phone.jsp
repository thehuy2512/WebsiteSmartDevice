...
<div class="container-fluid text-center" style="width: 90%;background-color: yellow;">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <p style="font-weight: 600;font-family: monospace;font-size: 30px">Thương hiệu Phone</p>
      <div style="background-color: white;"><a href="SanPhamThuongHieuController?maloai=dt&mathuonghieu=apple&tentrang=Phone" style="font-size: 40px;color: red;"><i class="uil uil-apple"></i> Apple</a></div>
      <div style="background-color: blue;"><a href="SanPhamThuongHieuController?maloai=dt&mathuonghieu=samsung&tentrang=Phone" style="font-size: 40px;color: white;">Samsung</a></div>
      <div style="background-color: green;"><a href="SanPhamThuongHieuController?maloai=dt&mathuonghieu=oppo&tentrang=Phone" style="font-size: 40px;color: white;"><i class="uil uil-android"></i> Oppo</a></div>
      <div style="background-color: black;"><a href="SanPhamThuongHieuController?maloai=dt&mathuonghieu=xiaomi&tentrang=Phone" style="font-size: 40px;color:orange;">Xiao mi</a></div>
